    ...
    render() {
        return (
            <div className="restaurant-card">
                ...
                <p className="item"><strong>Order: </strong>{this.props.item_name}</p>
                <img className="pic" src={this.props.item_photo} alt="Restaurant"/>
                <p className="inline"><strong>Meal Rating (1 to 5):</strong></p> <p className={`inline ${this.props.food_rating >= 3 ? "good" : "bad"}`}>{this.props.food_rating}</p>
